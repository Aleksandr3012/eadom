...
//Субъект
$mail->Subject = 'Заявка с сайта Частное строительство';
...
<table style="width: 100%;">';
    ...
    if (!empty($_POST['price'])) {
        $html .= ' <tr style="background-color: #f8f8f8;"> <td style="padding: 10px; border: #e9e9e9 1px solid;"> Где строительство дома?</td>   <td style="padding: 10px; border: #e9e9e9 1px solid;">' . $_POST['price'] . '</b></td>';
    }
    if (!empty($_POST['data'])) {
